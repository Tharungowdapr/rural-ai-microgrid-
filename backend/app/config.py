...
class Settings(BaseSettings):
    ...
    # ML
    MODEL_PATH: str = str(PROJECT_ROOT / "lstm_model.h5")
    SCALER_PATH: str = str(PROJECT_ROOT / "backend" / "ml" / "scaler.joblib")
    METRICS_PATH: str = str(PROJECT_ROOT / "backend" / "ml" / "metrics.json")
